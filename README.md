...
Please don't hesitate to [submit issues](https://github.com/khulnasoft-lab/free-disk-space/issues) to report problems or suggest new features (or sets of files to help remove).
